...
interface WorkSelector {
	//  do obliczania sumy rocznej oraz udzałów poszczególnych 
	...
	public List<Object> getSumAvg();  //  suma zł 	
	public void setSumAvg(List<Object> sumAvg);  // suma zł 
	...
	public double getAvgFuelCons();  // liczymy średni dla ostatniego zużytego tankowania  tu liczy zle bo bierze " z podanej świerzo wartości 
	public void setAvgFuelCons(int przebieg); 
